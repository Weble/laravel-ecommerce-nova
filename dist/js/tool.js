...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('manage-order-tool', __webpack_require__(3));
});
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                url = 'change-order-status/' + this.resourceId + '/' + transaction.replace(/\s/g, '_');
                                _context.next = 3;
                                return Nova.request().post('/nova-vendor/weble/laravel-ecommerce-nova/' + url);
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      { staticClass: "flex flex-row justify-left" },
      _vm._l(_vm.field.transitions, function(metadata, transition) {
        return _c("div", { key: transition, staticClass: "mr-2" }, [
          _c(
            "button",
            {
            ...
            [
              _vm._v(
                "\n                " +
                  _vm._s(metadata.title ? metadata.title : transition) +
                  "\n            "
              )
            ]
          )
